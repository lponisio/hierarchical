...
input1 <- c(code=nmixture.grouped,
            model.input)


## *********************************************************************
## re-write + custom samplers
## *********************************************************************
...
nmixture.grouped <- compareMCMCs(input1,
                                 MCMCdefs = MCMCdefs,
                                 MCMCs=c('nimble', "AFSS", "RWB5"),
                                 niter=niter,
                                 burnin = burnin,
                                 summary=FALSE,
                                 check=FALSE)
...
save(nmixture.grouped, file=file.path(save.dir, "grouped.Rdata"))
